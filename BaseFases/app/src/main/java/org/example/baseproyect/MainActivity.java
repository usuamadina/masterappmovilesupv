...
public class MainActivity extends Activity implements CameraBridgeViewBase.CvCameraViewListener2, LoaderCallbackInterface {
    ...
    public void onCameraViewStarted(int width, int height) {
        ...
        processor.setMostrarSalida(Processor.Salida.valueOf(valor));
        valor = preferencias.getString("intensidad", "SIN_PROCESO");
        processor.setTipoIntensidad(Processor.TipoIntensidad.valueOf(valor));
        valor = preferencias.getString("operador_local", "SIN_PROCESO");
        processor.setTipoOperadorLocal(Processor.TipoOperadorLocal.valueOf(valor));
        valor = preferencias.getString("binarizacion", "SIN_PROCESO");
        processor.setTipoBinarizacion(Processor.TipoBinarizacion.valueOf(valor));
        valor = preferencias.getString("segmentacion", "SIN_PROCESO");
        processor.setTipoSegmentacion(Processor.TipoSegmentacion.valueOf(valor));
        valor = preferencias.getString("reconocimiento", "SIN_PROCESO");
        processor.setTipoReconocimiento(Processor.TipoReconocimiento.valueOf(valor));
